...
five minutes of a game in which the score differential is 6 points or less (two-possession game). By examining the eWPA for each player
during these situations throughout the season, I can attempt to determine which player had the largest positive effect on eWP during
"clutch" situations.
...
(Although these probabilities were calculated for NBA games, I will be making the assumption that the eWPA for college basketball are
similar)
